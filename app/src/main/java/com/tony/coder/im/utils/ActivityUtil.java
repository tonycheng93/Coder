...
import com.tony.coder.im.ui.activity.SplashActivity;
...
public final class ActivityUtil {
    ...
    public static int[] getScreenSize() {
        ...
        dm = CoderApplication.getInstance().getResources().getDisplayMetrics();
    ...
    public static void show(final Context context, final String message) {
        final String msg = msgFilter != null ? msgFilter.filter(message) : message;
        CoderApplication.getInstance().getTopActivity().runOnUiThread(new Runnable() {

            public void run() {
                // Toast.makeText(activity, msg, Toast.LENGTH_SHORT).show();
                Toast.makeText(CoderApplication.getInstance().getTopActivity(), message, Toast.LENGTH_LONG).show();
